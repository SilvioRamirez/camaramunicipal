    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h3 class="text-center mb-4">Importar Extraordinaria</h3>
                <form id="uploadForm" action="{{ route('extraordinaria.store') }}" method="POST" enctype="multipart/form-data" class="mb-4">
                    @csrf
                    <div class="form-group">
                        <label for="extraordinaria">Seleccionar Archivo Extraordinaria:</label>
                        <input type="file" class="form-control" id="extraordinaria" name="extraordinaria" required>
                    </div>
                    <div class="form-group">
