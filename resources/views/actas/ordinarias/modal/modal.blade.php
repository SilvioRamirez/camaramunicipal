    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h3 class="text-center mb-4">Importar Ordinaria</h3>
                <form id="uploadForm" action="{{ route('ordinaria.store') }}" method="POST" enctype="multipart/form-data" class="mb-4">
                    @csrf
                    <div class="form-group">
                        <label for="ordinaria">Seleccionar Archivo Ordinaria:</label>
                        <input type="file" class="form-control" id="ordinaria" name="ordinaria" required>
                    </div>
                    <div class="form-group">
