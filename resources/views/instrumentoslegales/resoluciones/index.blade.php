...
@extends('layouts.app')
@section('title', 'Cargar Resoluciones')
@section('container')
    <!-- ./datatable -->
    ...
    @include('instrumentoslegales.resoluciones.modal.modal')
    @include('instrumentoslegales.resoluciones.datatable.datatable')
    ...
    <script>
        document.getElementById('uploadForm').addEventListener('submit', function(event) {
            const fileInput = document.getElementById('resolucion'); // Cambiado de 'gaseta' a 'resolucion'
    ...
    <script>
        function printTable() {
            ...
            win.document.write('<html><head><title>Imprimir Resoluciones</title>');
