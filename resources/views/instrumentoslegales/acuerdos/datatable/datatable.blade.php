...
<div class="card card-primary card-outline p-2">
    <div class="card-header">
        <h3 class="card-title">Acuerdos</h3> <!-- Agregar un título a la tarjeta -->
    </div>
    <div class="card-body">
            ...
            <tbody>
                @foreach($acuerdos as $acuerdo)
                    <tr>
                        ...
                        <td>
                            <a href="{{ Storage::url('public/' . $acuerdo->ruta) }}" class="btn btn-success btn-sm" target="_blank"><i class="fas fa-eye"></i> </a>                                  
                        </td>
                        <td>
                            <button type="button" class="btn btn-info btn-sm" onclick="printPDF('{{ Storage::url('public/' . $acuerdo->ruta) }}')">
                                <i class="fas fa-print"></i> 
                            </button>
                        </td>
                        <td>  
                            <a href="{{ route('acuerdos.download', $acuerdo->nombre) }}" class="btn btn-warning btn-sm"><i class="fa-solid fa-file-pdf"></i> </a>
                        </td>
                        <td>
