    ...
    @include('instrumentoslegales.gasetas.modal.modal')
    @include('instrumentoslegales.gasetas.datatable.datatable')
    <!-- script ----------------------------- -->
    <script>
        $('#example').DataTable({
        ...
        $(document).ready(function() {
            ...
            <script>
                document.getElementById('uploadForm').addEventListener('submit', function(event) {
                    const fileInput = document.getElementById('gaseta');
