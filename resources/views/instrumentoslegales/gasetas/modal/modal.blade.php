    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">             
                <h3 class="text-center mb-4">Importar Gaceta</h3>
                <form id="uploadForm" action="{{ route('gasetas.store') }}" method="POST" enctype="multipart/form-data" class="mb-4">
                    @csrf
                    <div class="form-group">
                        <label for="gaseta">Seleccionar Gaceta:</label>
                        <input type="file" class="form-control" id="gaseta" name="gaseta" required>                   
                    </div>        
