    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">             
                <h3 class="text-center mb-4">Importar Ordenanza</h3>
                <form id="uploadForm" action="{{ route('ordenanzas.store') }}" method="POST" enctype="multipart/form-data" class="mb-4">
                    @csrf
                    <div class="form-group">
                        <label for="ordenanza">Seleccionar Ordenanza:</label>
                        <input type="file" class="form-control" id="ordenanza" name="ordenanza" required>                   
                    </div>        
